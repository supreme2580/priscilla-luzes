    ...
    return(
        <div className="w-full px-4 sm:px-10" id="bio">
            ...
            <div className="w-full sm:flex justify-between space-x-4 space-y-4 mt-10">
                <div className="w-full text-white text-lg sm:text-2xl -mt-4 sm:mt-4">
                ...
                <div className="w-full h-auto bg-smallHero bg-cover bg-center h-screen hidden sm:block"></div>
            </div>
        </div>
    )
}